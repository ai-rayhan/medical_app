...
import 'package:medical_app/view/screens/home_screen.dart';
...
class _CustomNavigationDrawerState extends State<CustomNavigationDrawer> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          CustomNavigationDrawerWidget(),
        ],
      ),
    );
  }

  Widget CustomNavigationDrawerWidget() {
    double _height = MediaQuery.of(context).size.height;
    double _width = MediaQuery.of(context).size.width;
